...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview ${fn:startsWith(param.menu,'disk') ? 'active' : ''}" >
                <a href="/disk">
            ...
            <shiro:hasRole name="role_fin">
                ...
                <li class="treeview ${fn:startsWith(param.menu,'finance') ? 'active' : ''}" >
                        <a href="/finance">
                            <i class="fa fa-cogs"></i> <span>财务报表</span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li class="${param.menu == 'finance_day' ? 'active' : ''}">
                                <a href="/finance"><i class="fa fa-circle-o"></i> 日报</a>
                            </li>
                            <li class="${param.menu == 'sys_device' ? 'active' : ''}">
                                <a href="/finance/mouth"><i class="fa fa-circle-o"></i> 月报</a>
                            </li>
                            <li class="${param.menu == 'sys_device' ? 'active' : ''}">
